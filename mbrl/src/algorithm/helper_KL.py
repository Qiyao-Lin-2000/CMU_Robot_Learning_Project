...
def vae_enc(cfg):
    ...
    base = enc(cfg)
    last_dim = cfg.latent_dim

    mu_head      = nn.Linear(last_dim, last_dim)
    logvar_head  = nn.Linear(last_dim, last_dim)

    return nn.Sequential(base, nn.Tanh()), mu_head, logvar_head
